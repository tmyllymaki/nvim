  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', function()
        -- This is a slightly more advanced example of how to use Telescope.
        --  It uses `rg` (ripgrep) to find files, excluding the `.git` directory.
        --  You can change the `find_command` to use any command you want.
      ...
      vim.keymap.set('n', '<leader>je', builtin.lsp_document_symbols, { desc = '[ ] Jump to document symbols' })
      vim.keymap.set('n', '<leader>jd', builtin.lsp_dynamic_workspace_symbols, { desc = '[ ] Jump to dynamic workspace symbols' })
